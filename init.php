...
$sql = "CREATE TABLE IF NOT EXISTS users(ID int NOT NULL AUTO_INCREMENT,primary key (id),username CHAR(20), password CHAR(50), 
	email CHAR(25), type INT, adviser_id INT, code char(50), phone_number CHAR(20), name CHAR(15), family_name CHAR(25)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci";
